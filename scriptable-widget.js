// Scriptable iOS widget for the Codex quota bridge.
const QUOTA_URL = "http://100.124.44.113:8765/quota?token=3074abdc73ce3f65a7df619ec2611efc00d6";
...
function addMeter(widget, label, summary, width) {
  ...
  addText(top, label, { size: 12, color: COLORS.muted, font: Font.semiboldSystemFont(12) });
  top.addSpacer();
